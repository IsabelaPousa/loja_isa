...
<?php
    ...
    //Verifica o método de envio o FORM
    if($_SERVER["REQUEST_METHOD"] == "POST"){

         //Verifica se o campo do formulario esta vazio ultilizando a função empty
        ...
        if(empty($_POST["confirmarSenhaUsuario"])){
            ...
            $confirmarSenhaUsuario = $_POST["sconfirmarSenhaUsuarionhaUsuario"];
        }
